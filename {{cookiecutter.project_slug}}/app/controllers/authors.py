...
from app.models.authors import ReadDTO, Service, WriteDTO
...
async def get_authors(
    service: Service, filters: list[FilterTypes] = Dependency(skip_validation=True),
) -> list[ReadDTO]:
...
def create_router() -> Router:
    ...
    return Router(
        path="/authors",
        route_handlers=[create_author, delete_author, get_author, get_authors, update_author,],
